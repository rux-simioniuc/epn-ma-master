        ...
        with col1:
            ...
            if plant_files:
                ...
                if st.button(
                    ...
                    # FIX: guard against calling this before a mapping is loaded,
                    # which previously crashed with an AttributeError on None
